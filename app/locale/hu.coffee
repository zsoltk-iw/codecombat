module.exports = nativeDescription: "magyar", englishDescription: "Hungarian", translation:
  new_home:
    ...
    view_profile: "Profilom megtekintése"
    view_progress: "Fejlődés megtekintése"
    go_to_courses: "Kurzusaim megtekintése"
  ...
  nav:
    ...
    my_classrooms: "Osztályaim"
    my_courses: "Kurzusaim"
    careers: "Karrier"
    facebook: "Facebook"
    twitter: "Twitter"
    create_a_class: "Osztályt létrehozása"
    other: "Egyebek"
    learn_to_code: "Tanulj meg kódolni!"
    ...
    resource_hub: "Oktatási segédletek"
  ...
  diplomat_suggestion:
    ...
    missing_translations: "Magyar fordítás hiányában az eredeti angol szöveg jelenik meg."
  ...
  play:
    ...
    available: "Elérhető"
    skills_granted: "Megszerzett képességek" # Property documentation details
    ...
    subscription_required: "Csak előfizetéssel"
    subscribers_only: "Csak előfizetőknek!"
#    subscribe_unlock: "Subscribe to Unlock!"
    subscriber_heroes: "Fizess elő és ajándékba adjuk Amarat, Hushbaumot és Hattorit!"
    subscriber_gems: "A hős megvásárlásához fizes elő!"
    anonymous: "Anonymus Játékos"
    level_difficulty: "Nehézségi szint: "
    play_classroom_version: "Tantermi változat" # Choose a level in campaign version that you also can play in one of your courses
    campaign_beginner: "Kezdő hadjárat"
    awaiting_levels_adventurer_prefix: "Új pályák minden héten." # {change}
    awaiting_levels_adventurer: "Jelentkezz Kalandornak"
    awaiting_levels_adventurer_suffix: "legyél az első aki az új pályákon játszik."
    ...
    brain_pop_done: "Programoddal legyőzted az Ogrékat! Győztél!"
  ...
  code:
    ...
    "=": "értékadás (assign)"
    "==": "egyenlő (equals)"
    "===": "egyenlő (strictly equals)"
    "!=": "nem egyenlő (does not equal)"
    "!==": "nem egyenlő (does not strictly equal)"
    ">": "nagyobb mint (is greater than)"
    ">=": "nagyobb egyenlő mint (is greater than or equal)"
    "<": "kisebb mint (is less than)"
    "<=": "kisebb egyenlő (is less than or equal)"
    "*": "szorozva (multiplied by)"
    "/": "osztva (divided by)"
    "+": "plusz (plus)"
    "-": "minusz (minus)"
    "+=": "értékadás összeadással (add and assign)"
    "-=": "értékadás kivonással s(ubtract and assign)"
    True: "Igaz (true)"
    true: "igaz (true)"
    False: "Hamis (False)"
    false: "hamis (false)"
...
#    dont_use_our_email_silly: "Don't put our email here! Put your parent's email."
  ...
  common:
    ...
    publish: "Publikálás"
    create: "Létrehozás"
    fork: "Másolás" # There is no proper technical term for this in Hungarian.
    ...
    submit_patch: "Patch küldése"
    submit_changes: "Változások küldése"
  ...
  general:
    ...
    submitter: "Beküldő"
    submitted: "Beküldött"
    commit_msg: "Változtatás leírása"
    version_history: "Verzió történet"
    version_history_for: "Verzió történet: "
    select_changes: "Válassz két lehetőséget alul, hogy lásd a változásokat."
...
#    test_level: "Test Level"
    ...
    victory_experience_gained: "Megszerzett tapasztalat"
    victory_gems_gained: "Megszerzett Drágakövek"
    ...
    tome_cast_button_running: "Futtatás..."
    ...
    infinite_loop_description: "A kezdeti kód, ami a világot építi fel, nem fejeződött be. Valószínűleg nagyon lassú, vagy végtelen ciklust, esetleg hibát tartalmaz. Megpróbálkozhatsz a kód újrafuttatásával, vagy állítsd vissza a kódot az eredeti állapotba. Ha ez sem segít, kérlek tudasd velünk!"
    check_dev_console: "Továbbá megnyithatod a böngésző konzolját is (developer console), hogy lásd mi a hiba."
    check_dev_console_link: "(útmutató)"
    ...
    tip_forums: "Irány a fórum, és mondd el mit gondolsz!!"
